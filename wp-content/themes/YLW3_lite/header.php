...
<html>
	<head>
		...
		<?php wp_deregister_script( 'jquery' );wp_register_script( 'jquery', 'https://lib.sinaapp.com/js/jquery/1.8.2/jquery.min.js' , false, null, false );wp_enqueue_script( 'jquery' );?>
